...
<section class="page-title">
    <div class="container">
      <div class="row">
        <div class="col-12">
          ...
          <hr class="orn">
          <p class="pg-title">
          Selamat, saat ini anda sudah bisa menggunakan Omnifluencer
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="container konten text-center" style="min-height: 300px;">
    <p class="card-text" style="margin-top: 100px">
      Cari tau engagement rate akun Instagram sekarang
    Langsung klik link ► <a href="{{url('home')}}">Engagement Rate</a>
    </p>
